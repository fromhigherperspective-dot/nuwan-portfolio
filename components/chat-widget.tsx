...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {/* Chat panel */}
      <div className={`w-[calc(100vw-3rem)] sm:w-[380px] border border-border bg-background shadow-2xl flex flex-col transition-all duration-400 origin-bottom-right rounded-2xl overflow-hidden ${open ? 'opacity-100 scale-100 pointer-events-auto' : 'opacity-0 scale-95 pointer-events-none'}`} style={{ height: '500px' }}>
